package com.example.emily.facedetection;
...
import com.example.emily.facedetection.R;
...
public class FaceDetectionExample extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_face_detection_example);
    ...
    private void detectFaces(){
        if(null != cameraBitmap){
            ...
            String filepath = Environment.getExternalStorageDirectory() + "/DCIM" + System.currentTimeMillis() + ".jpg";
